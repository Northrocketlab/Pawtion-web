(function(root,factory){const api=factory();if(typeof module==='object'&&module.exports)module.exports=api;else root.PawtionNutrition=api;})(typeof globalThis!=='undefined'?globalThis:this,function(){
  ...
  function getEnergyFactor({species,stage,ageMonths,neutered,activity}){let factor;if(stage==='puppy')factor=ageMonths<4?ENERGY_FACTOR_CONFIG.growth.puppyUnderFourMonths:ENERGY_FACTOR_CONFIG.growth.puppyFourMonthsAndOlder;else if(stage==='kitten')factor=ENERGY_FACTOR_CONFIG.growth.kitten;else factor=ENERGY_FACTOR_CONFIG.adult[species][neutered==='yes'?'neutered':'intact'];return factor*ENERGY_FACTOR_CONFIG.activity[activity];}
