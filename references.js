const copy={th:{navHome:'หน้าหลัก',navCalc:'คำนวณอาหาร',navReferences:'แหล่งอ้างอิง',methodology:'แนวทางช่วงวัย',officialSource:'แหล่งข้อมูลทางการ ↗',methodNote:'เกณฑ์สุนัขในเครื่องคำนวณเป็นค่าประมาณตามขนาดตัวเพื่อใช้งานจริง ไม่ใช่ช่วงอายุคงที่ที่ AAHA กำหนด',title:'แหล่งอ้างอิง',intro:'พื้นที่สำหรับรวบรวมข้อมูล งานวิจัย และตัวอย่างที่เราจะนำไปพัฒนาส่วนต่าง ๆ ของหน้าหลักในภายหลัง',back:'กลับหน้าหลัก <span>→</span>',footer:'เพื่อทุกมื้อที่พอดี'},en:{navHome:'Home',navCalc:'Calculator',navReferences:'References',methodology:'Life-stage methodology',officialSource:'Official source ↗',methodNote:'Dog thresholds in the calculator are practical size-based estimates, not fixed age cutoffs prescribed by AAHA.',title:'References',intro:'A place to collect information, research and examples that can later guide updates to specific parts of the main page.',back:'Back to home <span>→</span>',footer:'For every perfectly portioned meal.'}};
