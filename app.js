...
const dictionary = {
  ...
  en: {
    navCalc:'Calculate food <span>↗</span>',heroEyebrow:'NUTRITION, SIMPLIFIED',heroTitle:'Just enough food<br /><em>for them.</em>',heroCopy:'A daily feeding guide for dogs and cats,<br class="desktop" /> based on the details that make them unique.',heroButton:'Start calculating <span>↓</span>',
